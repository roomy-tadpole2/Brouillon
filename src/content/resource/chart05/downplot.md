...
colormap = plt.get_cmap("RdYlBu").reversed()
...
plt.savefig("../figure/GO_enrichment_downregulated_genes_heatmap.png", dpi=500, bbox_inches='tight')
plt.savefig("../figure/GO_enrichment_downregulated_genes_heatmap.pdf", dpi=500, bbox_inches='tight')
...
![png](downplot_files/downplot_4_0.png)
